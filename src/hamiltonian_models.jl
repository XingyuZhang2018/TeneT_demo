...
export Ising, Heisenberg, J1J2, J1J2J3
export hamiltonian
...
return a struct representing the `Ni`x`Nj` J1J2 model with couplings `J1` and `J2`
"""
struct J1J2J3{T<:Real} <: HamiltonianModel
    Ni::Int
    Nj::Int
    J1::T
    J2::T
...
J1J2J3(Ni,Nj,J2,J3) = J1J2J3(Ni,Nj,1.0,J2,J3)
...
return the J1J2J3 hamiltonian for the `model` as a two-site operator.
"""
function hamiltonian(model::J1J2J3)
    hamiltonian(Heisenberg(model.Ni,model.Nj,model.J1,model.J1,model.J1)),
    hamiltonian(Heisenberg(model.Ni,model.Nj,model.J2,model.J2,model.J2)),
    hamiltonian(Heisenberg(model.Ni,model.Nj,model.J3,model.J3,model.J3))
end
