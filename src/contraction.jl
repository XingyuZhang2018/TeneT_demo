...
"""
function oc_Q_4_corner(Q, FLu, FLo, ACu, ACd, FRu, FRo, ARu, ARd, Au11, Ad11, Au12, Ad12, Au21, Ad21, Au22, Ad22; forloop_iter)
    Q = FLmap_forloop(FLo, Q, ACd, (Au21, Ad21); forloop_iter)
    Q = ACdmap_forloop(ARd, Q, FRo, (Au22, Ad22); forloop_iter)
    Q = FRmap_forloop(FRu, ARu, Q, (Au12, Ad12); forloop_iter)
    Q = ACmap_forloop(ACu, FLu, Q, (Au11, Ad11); forloop_iter)
...
function oc_D_leg4(FLu, FLo, ACu, ACd, FRu, FRo, ARu, ARd, Au11, Ad11, Au12, Ad12, Au21, Ad21, Au22, Ad22; forloop_iter)
    ...
    D1 = size(Au21, 4)
    D2 = size(Ad21, 4)
    # Q = Zygote.@ignore rand!(similar(FLu, χ,D1,D2,χ))
    Q = Zygote.@ignore _arraytype(FLu)(randn(eltype(FLu), χ,D1,D2,χ))
    Q = oc_Q_4_corner(Q, FLu, FLo, ACu, ACd, FRu, FRo, ARu, ARd, Au11, Ad11, Au12, Ad12, Au21, Ad21, Au22, Ad22; forloop_iter)
    Q, _ = TeneT.qrpos(reshape(Q, χ*D1*D2, χ))
    Q = reshape(Q, χ,D1,D2,χ)

    QQ = oc_Q_4_corner(Q, FLu, FLo, ACu, ACd, FRu, FRo, ARu, ARd, Au11, Ad11, Au12, Ad12, Au21, Ad21, Au22, Ad22; forloop_iter)
    return sum(ein"abcd,abcd->"(conj(Q), QQ))
    # return @tensor conj(Q[a,b,c,d]) * QQ[a,b,c,d]
end
...
function oc_H3_leg4(FLo, ACu, ACd, FRo, ARu1, ARd1, ARu2, ARd2, A1u, A1d, A2u, A2d, A3u, A3d; forloop_iter)
    l = FLmap_forloop(FLo, ACu, ACd, (A1u, A1d); forloop_iter)
    l = FLmap_forloop(l, ARu1, ARd1, (A2u, A2d); forloop_iter)
    r = FRmap_forloop(FRo, ARu2, ARd2, (A3u, A3d); forloop_iter)
    return sum(ein"abcd,abcd->"(l,r))
end

function contract_n3_H(FLo::leg4, ACu, ACd, FRo, ARu1, ARd1, ARu2, ARd2, A1, A2, A3; forloop_iter)
    return oc_H3_leg4(FLo, ACu, ACd, FRo, ARu1, ARd1, ARu2, ARd2, A1, conj(A1), A2, conj(A2), A3, conj(A3); forloop_iter)
end

function contract_o3_H(FLo::leg4, ACu, ACd, FRo, ARu1, ARd1, ARu2, ARd2, A1, A2, A3, O1, O2; forloop_iter)
    Dh = size(O1, 3)
    atype = _arraytype(O1)
    IDh = Zygote.@ignore atype(Matrix{Float64}(I, Dh, Dh))
    D1,D2,D3,D4,d = size(A1)
    ...
    A3d = conj(A3)
    return oc_H3_leg4(FLo, ACu, ACd, FRo, ARu1, ARd1, ARu2, ARd2, A1u, A1d, A2u, A2d, A3u, A3d; forloop_iter)
end

function oc_V3_leg4(ACu, ACd, FLu1, FRu1, FLu2, FRu2, FLo, FRo, A1u, A1d, A2u, A2d, A3u, A3d; forloop_iter)
    u = ACmap_forloop(ACu, FLu1, FRu1, (A1u, A1d); forloop_iter)
    u = ACmap_forloop(u, FLu2, FRu2, (A2u, A2d); forloop_iter)
    u = ACmap_forloop(u, FLo, FRo, (A3u, A3d); forloop_iter)
    return sum(ein"abcd,abcd->"(u,ACd))
end

function contract_n3_V(ACu::leg4, ACd, FLu1, FRu1, FLu2, FRu2, FLo, FRo, A1, A2, A3; forloop_iter)
    return oc_V3_leg4(ACu, ACd, FLu1, FRu1, FLu2, FRu2, FLo, FRo, A1, conj(A1), A2, conj(A2), A3, conj(A3); forloop_iter)
end

function contract_o3_V(ACu::leg4, ACd, FLu1, FRu1, FLu2, FRu2, FLo, FRo, A1, A2, A3, O1, O2; forloop_iter)
    Dh = size(O1, 3)
    atype = _arraytype(O1)
    IDh = Zygote.@ignore atype(Matrix{Float64}(I, Dh, Dh))
    D1,D2,D3,D4,d = size(A1)
    ...
    A3d = conj(A3)
    return oc_V3_leg4(ACu, ACd, FLu1, FRu1, FLu2, FRu2, FLo, FRo, A1u, A1d, A2u, A2d, A3u, A3d; forloop_iter)
end